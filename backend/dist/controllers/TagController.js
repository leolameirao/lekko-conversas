...
exports.syncTags = exports.updateKanban = exports.kanban = exports.list = exports.remove = exports.update = exports.show = exports.store = exports.index = void 0;
...
const UpdatePositionKanbanServices_1 = require("../services/TagServices/UpdatePositionKanbanServices");
...
const updateKanban = async (req, res) => {
    const { companyId } = req.user;
    const data = req.body;
    await (0, UpdatePositionKanbanServices_1.UpdatePositionKanbanServices)(data);
